...
module types:
  ...
  typedTempl "cast", [AnyTy, TypeTy[AnyTy]], AnyTy:
    ...
    newStmt[] = args[0][]
    newStmt.knownType = context.scope.module.evaluateStatic(args[1]).typeValue.type.unwrapTypeType
  ...
  # XXX [types, macros] .call / .[] for type arguments, and generics in general
